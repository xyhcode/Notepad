 ...
 *
 */
public class Serviceterms extends JFrame implements ActionListener{
	JDialog jd;
	JScrollPane js;
	JButton jbu2;
	public Serviceterms() {
	...
	public JPanel CreatePanl() {
		JPanel jp=new JPanel();
		Box bx=Box.createVerticalBox();
		Box bx1=Box.createHorizontalBox();
		JTextArea jte =new JTextArea(22,60);
		jte.setCaretPosition(0);
		jte.setBorder(null);
		jte.setBorder(BorderFactory.createLoweredBevelBorder());
		js = new JScrollPane(jte);//滚动条
		js.setHorizontalScrollBarPolicy(JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);//去掉底部的滚动条
		jte.setLineWrap(true);
		jte.setCaretPosition(getState());
//		jte.setCaretPosition(0);
		//文本内容
		jte.setText("最后更新日期：2018 年 6 月\r\n" + 
				"微软软件许可条款\r\n" + 
				"WINDOWS 操作系统\r\n" + 
				"如果您居住（或业务主营地）在美国，请阅读第 11 节中具有约束力的仲裁条款和共同起诉弃权，它影响争议的解决方式。\r\n" + 
				"感谢您选择微软！\r\n" + 
				"根据您获取 Windows 软件的方式，这是 (i) 您与设备制造商或使用您的设备分销软件的软件安装商之间的许可协议；或 (ii) 您与微软公司（或其位于您居住所在地或业务主营地的关联公司之一）之间的许可协议，前提是您的软件是从零售商处购买的。微软是微软或其关联公司之一所生产设备的设备制造商，如果您的软件是直接从微软购买的，则微软还是零售商。注意：如果您是批量许可客户，则您对该软件的使用应受批量许可协议的约束，而不是本协议的约束。\r\n" + 
				...
				"(ii)	微软、设备制造商或安装商可能会提供额外的应用程序，这些应用程序将受单独的许可条款和隐私政策的约束。\r\n" + 
				...
				"c.	限制。设备制造商或安装商以及微软保留本协议中未明确授予的所有权利（如依据知识产权法享有的权利）。例如，本许可未授予您任何以下权利，并且您不得：\r\n" + 
				"(i)	单独使用或虚拟化软件的功能；\r\n" + 
				"(ii)	发布、复制（除允许的备份复制之外）、出租、租赁或出借软件；\r\n" + 
				"(iii)	转让软件（除非本协议允许）；\r\n" + 
				"(iv)	绕过软件中的任何技术限制；\r\n" + 
				"(v)	将软件用作服务器软件，用于商业托管服务，通过网络提供该软件以供多个用户同时使用，将软件安装在服务器上并允许用户远程访问，或将软件安装在设备上仅供远程用户使用；\r\n" + 
				"(vi)	对该软件进行反向工程、反向编译或反汇编，或试图进行上述行为，除非且仅限于上述限制存在以下情形：(a) 适用法律允许；(b) 约束该软件可能包含的开源组件的使用的许可条款允许；或者 (c) 在该软件所包含或链接的 GNU 宽通用公共许可协议的许可下，进行必要的库变更调试；以及\r\n" + 
				...
				"7.	降级权利。如果您从制造商或安装商处购买的设备上预安装了 Windows 专业版且其被配置为以完整的功能模式运行，则您可使用 Windows 8.1 专业版或 Windows 7 专业版，但您仅可在 Microsoft 为该早期版本提供支持期间使用，相关规定请访问 (aka.ms/windowslifecycle)。使用早期版本时，您应遵守本协议。如果早期版本包含不同的组件，那么在使用这些组件时，您应遵守该早期版本附带的协议中所有适用于这些组件的条款。设备制造商、安装商或 Microsoft 均没有义务向您提供早期版本。您必须另行获得早期版本，这可能会产生一定的费用。您随时可以使用最初购买的版本替代早期版本。\r\n" + 
				"8.	出口限制。您必须遵守适用于该软件的所有国内和国际出口法律和法规，其中包括对目的地、最终用户和最终用途的各种限制。有关出口限制的详细信息，请访问 (aka.ms/exporting)。\r\n" + 
				"9.	保证、免责声明、补偿、损失和程序。\r\n" + 
				"a.	有限保证。根据您获得微软软件的方式，微软、设备制造商或安装商保证，获得适当许可的软件会基本上按照软件附带的任何微软材料说明的方式运行。由您造成、或因您未遵守相关说明而引起、由超出微软、设备制造商或安装商合理控制范围的活动所造成的问题不在本有限保证范围之内。如果从微软该软件，或从设备制造商或安装商处购买该软件九十 (90) 天内，本有限保证自首位用户购买该软件起有效并持续一年时间。如果您在设备制造商的有限保证的九十 (90) 天期限内直接从微软获得更新或补充程序，微软会为这些更新或补充程序提供有限保证。如果从微软该软件，或从设备制造商或安装商处购买该软件九十 (90) 天内，您在这一年期限内从微软处收到的对该软件的补充程序、更新或更换也可以享受有限保证，但仅在该一年内剩余的有效期或 30 天内（以两者中时间较长者为准）享受有限保证。转让软件不会延长本有限保证。\r\n" + 
				"b.	免责声明。微软、设备制造商和安装商均不提供任何其他明示保证、保障或条件。微软、设备制造商和安装商排除所有默示保证和条件，包括适销性、针对特定用途的适用性和不侵权的默示保证。如果您当地的法律不允许排除默示保证，则任何默示保证、保障或条件仅在有限保证期限内有效，且仅限于您当地的法律所允许的范围。如果您当地的法律要求更长的有限保证期限，则尽管有本协议，更长的期限将适用，但您只能获得本协议允许的补偿。\r\n" + 
				"c.	有限补偿。如果微软、设备制造商和安装商违反其有限保证，则微软将自行选择：(i) 免费修复或更换该软件，或 (ii) 退还购买该软件（或预安装该软件的设备，由其自行选择）支付的金额（如有）并收回产品。设备制造商或安装商（或微软，如果您直接从微软购买）也可以修复或更换该软件的补充程序、更新和更换，或退还您支付的金额（如有）。这些是在违反保证的情况下您所能获得的唯一补偿。除了本有限保证提供的特定合法权利外，根据各州或者各个国家/地区的不同法律，您还可能享有其他权利。\r\n" + 
				"d.	损害除了微软、设备制造商或安装商可能提供的任何修复、更换或退款之外，依据本有限保证、本协议的任何其他部分或任何理论，您不能因任何损害获得赔偿或其他补偿，包括利润损失、直接损害、后果性损害、特别损害、间接损害或附带损害。即使修复、更换或退款未完全补偿您的损失，如果微软、设备制造商或安装商知道或应该知道可能会出现损害，或者如果补偿未能达到其基本目的，本协议中的损害排除和补偿限制也同样适用。某些州和国家/地区不允许排除或限制附带损害赔偿、后果性损害赔偿或其他损害赔偿责任，因此这些限制或排除条款可能对您不适用。如果您当地的法律允许您因损害从微软、设备制造商或安装商处获得退款，则即使本协议不允许，您也可以获得，但您获得的退款不能超过您为该软件支付的金额（或者如果软件是免费获取的，则获得的金额上限为 50 美元）。\r\n" + 
				"e.	保证和退款程序。对于服务或退款，如果您从微软购买该软件，您必须提供购买凭证的副本并遵守微软的退回政策，或者，如果您从设备制造商或安装商处购买该软件，您需要遵守设备制造商或安装商的退回政策。如果您购买了独立软件，按照这些退回政策的要求，您可能需要卸载软件并将其归还到微软。如果您所购买了设备上的预装软件，退回政策可能需要您将软件连同安装软件的整个设备退回给微软；必须仍贴附包括产品密钥的“正版证书”标签（如果随设备一起提供）。请通过与您的设备一起提供的地址或免费电话与设备制造商或安装商联系，了解如何获得软件的保证服务。如果微软是您的设备制造商或者您的软件是从零售商处购买的，请通过以下方式联系微软：\r\n" + 
				"(i)	美国和加拿大。要了解保证服务或有关如何获得在美国或加拿大购买的软件的退款之信息，请通过以下方式联系微软：致电 (800) MICROSOFT；或发邮件至 Microsoft Customer Service and Support,One Microsoft Way, Redmond, WA 98052-6399, USA；或访问 (aka.ms/nareturns)。\r\n" + 
				"(ii)	欧洲、中东和非洲。如果您是在欧洲、中东或非洲购买的软件，请联系 Microsoft Ireland Operations Limited, Customer Care Centre, Atrium Building Block B, Carmanhall Road, Sandyford Industrial Estate, Dublin 18, Ireland，或者联系为您所在国家/地区提供服务的微软关联公司，网址为 (aka.ms/msoffices)。\r\n" + 
				"(iii)	澳大利亚。如果您是在澳大利亚购买的软件，请通过以下方式联系微软以提出索赔：致电 13 20 58 或寄信至 Microsoft Pty Ltd, 1 Epping Road, North Ryde NSW 2113 Australia。\r\n" + 
				"(iv)	其他国家/地区。如果您是在其他国家/地区购买的软件，请联系为您所在国家/地区提供服务的微软关联公司，网址为 (aka.ms/msoffices)。\r\n" + 
				"10.	支持。\r\n" + 
				"a.	对于预安装在设备上的软件。有关该软件的一般支持选项，请向设备制造商或安装商咨询。可参见随软件提供的支持电话号码。对于直接从微软获取的更新和补充程序，微软可能会为获得适当许可的软件提供有限的支持服务，详见 (aka.ms/mssupport)。\r\n" + 
				"b.	对于从零售商处购买的软件。微软为具有适当许可的软件提供有限支持服务，详见 (aka.ms/mssupport)。\r\n" + 
				"11.	具有约束力的仲裁条款和共同起诉弃权（如果您的居住地或业务主营地在美国）。\r\n" + 
				"我们希望我们绝不会有争议，但如果发生了，您与我们同意尝试在六十 (60) 天内对争议进行非正式解决。如果我们无法解决，您与我们同意按照《联邦仲裁法》（以下简称“FAA”）接受美国仲裁协会（以下简称“AAA”）的有约束力的独立仲裁，而不是在法官或陪审团面前进行法律诉讼。中立的仲裁员将对争议进行裁决，并且仲裁员的裁决为最终裁决，但依据 FAA 享有有限审查权的除外。不允许共同起诉、共同范围的仲裁、检察长私人诉讼以及代理人提起的任何其他诉讼。如果未取得所有方的同意，也不得将单独的诉讼进行合并。“我们”和“我们的”包括微软、设备制造商和软件安装商。\r\n" + 
				"a.	涉及除知识产权之外的所有内容的争议。术语“争议”具有尽可能广泛的含义。它包含您与设备制造商或安装商之间或者您与微软之间，依据包括合同、保证、侵权法、法令或法规在内的任何法理，就软件、软件价格或本协议而产生的任何索赔或争论，但不包括与您、您的许可方、我们或我们的许可方的知识产权的执行或有效性有关的争议。\r\n" + 
				"b.	首先寄出争议通知。如果您有争议并且我们的客户服务代表无法解决，请通过美国邮政向设备制造商或安装商发送邮件，收件人：法律部。如果您的争议与 Microsoft 有关，请将争议通知寄给微软公司，收件人：CELA ARBITRATION, One Microsoft Way, Redmond, WA 98052-6399, USA。告诉我们您的姓名、地址、联系方式、问题所在以及您想要的结果。相关表格，请访问 (aka.ms/disputeform)。如果我们有与您有关的争议，同样也会这样做。六十 (60) 天后，如果争议未解决，您或我们可能会启动仲裁。\r\n" + 
				"c.	小额索赔法院选择。如果您不愿意邮寄争议通知，并且您满足法院的要求，则可在您的居住县（或者您的业务主营地）或我们的主营地 — 美国华盛顿州金县（如果您的争议与 Microsoft 有关）的小额索赔法院起诉我们。\r\n" + 
				"d.	仲裁程序。AAA 将依据其商事仲裁规则处理任何仲裁（如果您是个人并将该软件用于个人或家庭用途，或者争议的价值为 75,000 美元或以下金额，则无论您是否是个人或者无论您如何使用该软件，均将依据其消费者仲裁规则处理）。有关详细信息，请访问 (aka.ms/adr) 或致电 1-800-778-7879。若要启动仲裁，请将 (aka.ms/arbitration) 上提供的表格提交给 AAA；并将副本寄给设备制造商或安装商（如果您的争议与微软有关，则寄给微软）。在涉及 25,000 美元或以下金额的争议中，任何听证均将用电话传送，除非仲裁员找到合适的理由用在场听证取代。任何在场听证将在您的居住县（或业务主营地）或我们的业务主营地 - 华盛顿州的金县（如果您的争议与 Microsoft 有关）举行。具体由您选择。仲裁员可以像法院那样判给您个人相同的损害赔偿金。仲裁员只能判给您个人确认性或禁止令救济，以满足您的个人索赔。依据 AAA 规则，仲裁员在其自己管辖权地进行裁定，包括索赔的可仲裁性。但是法院拥有强制禁止集体性或代表性仲裁的唯一授权。\r\n" + 
				"e.	仲裁费用和支付。\r\n" + 
				"(i)	涉及 75,000 美元或以下金额的争议。设备制造商或安装商（或微软，如果您的争议与微软有关）将及时补偿您的立案费并支付 AAA 和仲裁员的费用与支出。如果您拒绝我们在指定仲裁员之前作出的最后的书面庭外和解提议，您的争议最后将由仲裁员决定（称为“判决”），且如果仲裁员判给您超过此最后的书面提议的金额，设备制造商或安装商（或微软，如果您的争议与微软有关）将：(1) 支付判决金额或 1,000 美元两者间较大的金额；(2) 支付您合理的律师费（如有）；以及 (3) 补偿您的律师就在仲裁中调查、准备和进行索赔而合理产生的任何费用（包括专家证人费）。\r\n" + 
				"(ii)	涉及金额超过 75,000 美元的争议。AAA 规则将管辖立案费以及 AAA 和仲裁员的费用与支出。\r\n" + 
				"f.	必须在一 (1) 年内提出。您和我们必须在从争议最早可以提出的时间起的一 (1) 年内就任何索赔或争议向小额索赔法院起诉或提起仲裁（知识产权争议除外 - 请参阅第 11.a. 节）。否则，索赔或争议将被永久禁止。\r\n" + 
				"g.	可分割性。如果第 11 节的部分条款（具有约束力的仲裁条款和共同起诉弃权）被发现为非法的或不可执行的，其余部分将保持有效（在任何审批程序开始之前发出仲裁裁决）。例外是：发现部分违法性或不可执行性将导致集体性或有代表性的仲裁，第 11 节整体上不可执行。\r\n" + 
				"h.	与 AAA 规则冲突。如果本协议与 AAA 的商事仲裁规则或消费者仲裁规则相冲突，则以本协议为准。\r\n" + 
				"i.	微软作为一方或第三方受益人。如果微软是设备制造商或者您的软件是从零售商处购买的，则微软为本协议的一方。否则，微软不是本协议的一方，但是您和设备制造商或安装商的协议的第三方受益人，以通过非正式协商和仲裁解决争议。\r\n" + 
				"12.	管辖法律。您所居住的州或国家/地区（若为企业，则为主要营业地）的法律管辖有关软件、软件价格或本协议的所有索赔和争议项目，包括违约索赔和根据消费者保护法、不正当竞争法、默示保证法、不当得利法以及侵权法提出的相关索赔，但不考虑冲突法原则。在美国，FAA 制约所有与仲裁相关的条款。\r\n" + 
				"13.	消费者权利，地区差异。本协议规定了某些合法权利。根据您所在州或国家/地区的法律规定，您可能享有其他权利（包括消费者权利）。您还可能享有与您的软件卖方相关的权利。如果您所在州或国家/地区的法律不允许本协议改变这些其他权利，则本协议将不改变这些其他权利。例如，如果您的软件是从下列地区之一购买的，或强制性的国家/地区法律适用，则下列条款适用于您：\r\n" + 
				"a.	澳大利亚。提及的“有限保证”是指微软或设备制造商或安装商提供的明示保证。除了依照法律所拥有的其他权利和补偿（包括您依据澳大利亚消费者法中的消费者保障享有的权利和补偿），您还拥有此保证。此协议中的任何内容都不限制和更改那些权利和补偿。特别：\r\n" + 
				"(i)	在第 9 节标题为 “保证、免责声明、补偿、损失和程序” 的本地法律中排除有限保证、保障、损害和补偿，以及您的有限权利的期限的条款不适用于澳大利亚消费者法消费者保障和您在权利和补偿方面的权益；\r\n" + 
				"(ii)	有关支持和退款政策，请参考第 10 节，并受澳大利亚消费者法律约束。\r\n" + 
				"(iii)	澳大利亚消费者法消费者保障适用于第 14 d (ii) 节所述的软件评测和第 14 d (iv) 节所述的软件预览；和\r\n" + 
				"(iv)	《澳大利亚消费者法》中的规定不会排除我们的商品附带的保障。在本节中， “产品” 指微软或设备制造商或安装商为其提供明示保证的软件。您有权就重大故障要求更换商品或退款，并就任何其他合理可预见的损失或损害获得补偿。您还有权在商品无法提供可接受的质量而存在的故障又不构成重大故障时要求维修或更换商品。\r\n" + 
				"有关更多澳大利亚消费者法中您的权利，请查阅“aka.ms/acl”中信息。\r\n" + 
				"b.	加拿大。您可通过禁用 Internet 访问来停止接收设备更新。如果重新连接到 Internet，软件将继续检查并安装更新。\r\n" + 
				"c.	欧盟。下文第 14.d(i) 节中的学术使用限制不适用于以下站点上所列的管辖权地：(aka.ms/academicuse) 。\r\n" + 
				"d.	德国和奥地利。\r\n" + 
				"(i)	保证。获得适当许可的软件会基本上按照该软件附带的任何 Microsoft 材料说明的方式运行。但是，设备制造商或安装商和微软未提供任何与许可软件相关的合同保障。\r\n" + 
				"(ii)	责任限制。如果出现基于产品责任法的故意行为、重大过失、索赔以及出现死亡或人身伤害的情况，设备制造商或安装商或微软将依据成文法负责。\r\n" + 
				"根据前面的声明，设备制造商或安装商或微软将仅对以下情况的轻微过失负责：设备制造商或安装商或微软违反此类实质性合同义务、未履行促使本协议正常执行的义务、危及本协议的目的的义务违反行为以及未能遵守一方可能一直相信要履行的义务（所谓的“基本义务”）。在其他轻微过失情况下，设备制造商或安装商或微软不对轻微过失负责。\r\n" + 
		...
		jbu2=new JButton("     确定     ");
		jbu2.setFont(new Font("微软雅黑",Font.PLAIN,16));
		bx2.add(Box.createHorizontalStrut(830));
		bx2.add(jbu2);
		jbu2.addActionListener(this);
		
		bx.add(Box.createVerticalStrut(25));
		bx.add(bx1);
		bx.add(Box.createVerticalStrut(25));
		bx.add(bx2);
		jp.add(bx);
